...
public class Bill {
    ...
    public Bill(int id, float idBill, int idMovie, String movieName, String moviePremiere, int moviePrice, String dateOrder, String timeOrder, String selectedChair, String selectedFood, String methodPayment, String email, float totalPrice) {
        Id = id;
        IdBill = idBill;
        IdMovie = idMovie;
        MovieName = movieName;
    ...
    public float getIdBill() {
        return IdBill;
    }

    public void setIdBill(float idBill) {
        IdBill = idBill;
    }
