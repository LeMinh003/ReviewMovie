...
//
//        String[] timesArray = getResources().getStringArray(R.array.time_items);
//        // Tạo danh sách mới chỉ chứa các mục chưa trôi qua
...
//        // Tạo adapter mới cho Spinner với danh sách đã lọc
//        ArrayAdapter<String> newadapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, validTimes);
//        newadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//        spnTime.setAdapter(newadapter);
